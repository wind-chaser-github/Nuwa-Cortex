...
from guide_cortex.agent import model_presets as preset_helpers
from guide_cortex.agent.autocompact import AutoCompact
from guide_cortex.agent.context import ContextBuilder
from guide_cortex.agent.hook import AgentHook, CompositeHook
from guide_cortex.agent.memory import Consolidator, Dream
from guide_cortex.agent.progress_hook import AgentProgressHook
from guide_cortex.agent.runner import _MAX_INJECTIONS_PER_TURN, AgentRunner, AgentRunSpec
from guide_cortex.agent.subagent import SubagentManager
from guide_cortex.agent.tools.file_state import FileStateStore, bind_file_states, reset_file_states
from guide_cortex.agent.tools.message import MessageTool
from guide_cortex.agent.tools.registry import ToolRegistry
from guide_cortex.agent.tools.self import MyTool
from guide_cortex.bus.events import InboundMessage, OutboundMessage
from guide_cortex.bus.queue import MessageBus
from guide_cortex.command import CommandContext, CommandRouter, register_builtin_commands
from guide_cortex.config.schema import AgentDefaults, ModelPresetConfig
from guide_cortex.providers.base import LLMProvider
from guide_cortex.providers.factory import ProviderSnapshot
from guide_cortex.session.manager import Session, SessionManager
from guide_cortex.utils.artifacts import generated_image_paths_from_messages
from guide_cortex.utils.document import extract_documents
from guide_cortex.utils.helpers import image_placeholder_text
from guide_cortex.utils.helpers import truncate_text as truncate_text_fn
from guide_cortex.utils.image_generation_intent import image_generation_prompt
from guide_cortex.utils.runtime import EMPTY_FINAL_RESPONSE_MESSAGE
from guide_cortex.utils.webui_titles import mark_webui_session, maybe_generate_webui_title_after_turn

if TYPE_CHECKING:
    from guide_cortex.config.schema import (
        ChannelsConfig,
        ProviderConfig,
        ToolsConfig,
    )
...
class AgentLoop:
    ...
    def __init__(
        ...
        memory_tree_config: Any | None = None,
    ):
        from guide_cortex.config.schema import MemoryTreeConfig, ToolsConfig
        ...
        memory_tree_adapter = None
        oh = memory_tree_config or MemoryTreeConfig()
        if oh.enabled:
            memory_tree_adapter = MemoryTreeAdapter.from_config(oh, guide_workspace=workspace)

        self.context = ContextBuilder(
            workspace,
            timezone=timezone,
            disabled_skills=disabled_skills,
            memory_tree=memory_tree_adapter,
        )
    ...
    def from_config(
        ...
        **extra: Any,
        ...
        """
        from guide_cortex.providers.factory import make_provider
        ...
        return cls(
            ...
            memory_tree_config=config.memory_tree,
            **extra,
        )
    ...
    async def _connect_mcp(self) -> None:
        ...
        from guide_cortex.agent.tools.mcp import connect_mcp_servers
    ...
    def _set_tool_context(
        ...
        from guide_cortex.agent.tools.context import ContextAware, RequestContext
