...
from guide_cortex.agent.runner import AgentRunner, AgentRunSpec
from guide_cortex.agent.tools.registry import ToolRegistry
from guide_cortex.session.manager import Session
from guide_cortex.utils.gitstore import GitStore
...
class Dream:
    ...
    def _build_tools(self) -> ToolRegistry:
        ...
        from guide_cortex.agent.skills import BUILTIN_SKILLS_DIR
        from guide_cortex.agent.tools.file_state import FileStates
        from guide_cortex.agent.tools.filesystem import EditFileTool, ReadFileTool, WriteFileTool
