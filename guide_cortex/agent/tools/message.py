...
from guide_cortex.agent.tools.schema import ArraySchema, StringSchema, tool_parameters_schema
from guide_cortex.bus.events import OutboundMessage
from guide_cortex.config.paths import get_workspace_path
...
class MessageTool(Tool, ContextAware):
    ...
    async def execute(
        ...
        **kwargs: Any
        ...
        from guide_cortex.utils.helpers import strip_think
