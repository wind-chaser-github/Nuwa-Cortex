...
from guide_cortex.agent.tools.sandbox import wrap_command
...
class ExecTool(Tool):
    ...
    def __init__(
        ...
        self.deny_patterns = (deny_patterns or []) + [
            ...
            r":\(\)\s*\{.*\};\s*:",          # fork bomb
            # Block writes to guide_cortex internal state files (#2989).
    ...
    def _guard_command(self, command: str, cwd: str) -> str | None:
        ...
        from guide_cortex.security.network import contains_internal_url
