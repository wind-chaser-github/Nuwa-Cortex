"""MCP client: connects to MCP servers and wraps their tools as native guide_cortex tools."""
...
from guide_cortex.agent.tools.base import Tool
...
class MCPToolWrapper(Tool):
    """Wraps a single MCP server tool as a guide_cortex Tool."""
...
class MCPResourceWrapper(Tool):
    """Wraps an MCP resource URI as a read-only guide_cortex Tool."""
...
class MCPPromptWrapper(Tool):
    """Wraps an MCP prompt as a read-only guide_cortex Tool."""
