...
from guide_cortex.agent.tools.schema import IntegerSchema, StringSchema, tool_parameters_schema
from guide_cortex.config.schema import Base
from guide_cortex.utils.helpers import build_image_content_blocks
        ...
        try:
            async with httpx.AsyncClient(proxy=self.proxy, follow_redirects=True, max_redirects=MAX_REDIRECTS, timeout=15.0) as client:
                async with client.stream("GET", url, headers={"User-Agent": self.user_agent}) as r:
                    from guide_cortex.security.network import validate_resolved_url
