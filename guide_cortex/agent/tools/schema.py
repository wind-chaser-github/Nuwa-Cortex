"""JSON Schema fragment types: all subclass :class:`~guide_cortex.agent.tools.base.Schema` for descriptions and constraints on tool parameters.

- ``to_json_schema()``: returns a dict compatible with :meth:`~guide_cortex.agent.tools.base.Schema.validate_json_schema_value` /
  :class:`~guide_cortex.agent.tools.base.Tool`.
...
Shared validation and fragment normalization are on the class methods of :class:`~guide_cortex.agent.tools.base.Schema`.
...
from guide_cortex.agent.tools.base import Schema
