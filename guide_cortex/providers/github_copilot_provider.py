...
TOKEN_APP_NAME = "guide_cortex"
USER_AGENT = "guide_cortex/0.1"
...
class GitHubCopilotProvider(OpenAICompatProvider):
    ...
    async def _get_copilot_access_token(self) -> str:
        ...
        if not github_token or not github_token.access:
            raise RuntimeError("GitHub Copilot is not logged in. Run: guide_cortex provider login github-copilot")
