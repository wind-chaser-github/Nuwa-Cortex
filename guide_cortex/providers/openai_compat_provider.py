...
from guide_cortex.providers.base import LLMProvider, LLMResponse, ToolCallRequest
from guide_cortex.providers.openai_responses import (
    consume_sdk_stream,
    convert_messages,
    convert_tools,
...
if TYPE_CHECKING:
    from guide_cortex.providers.registry import ProviderSpec
