...
from guide_cortex.config.schema import Config, InlineFallbackConfig, ModelPresetConfig
from guide_cortex.providers.base import LLMProvider
from guide_cortex.providers.fallback_provider import FallbackProvider
...
def _make_provider_core(
    ...
    *,
    ...
    if backend == "openai_codex":
        from guide_cortex.providers.openai_codex_provider import OpenAICodexProvider

        provider = OpenAICodexProvider(default_model=model)
    elif backend == "azure_openai":
        from guide_cortex.providers.azure_openai_provider import AzureOpenAIProvider
        ...
        from guide_cortex.providers.github_copilot_provider import GitHubCopilotProvider

        provider = GitHubCopilotProvider(default_model=model)
    elif backend == "anthropic":
        from guide_cortex.providers.anthropic_provider import AnthropicProvider
        ...
        from guide_cortex.providers.bedrock_provider import BedrockProvider
        ...
        from guide_cortex.providers.openai_compat_provider import OpenAICompatProvider
...
def load_provider_snapshot(
    ...
    *,
    ...
    from guide_cortex.config.loader import load_config, resolve_config_env_vars
