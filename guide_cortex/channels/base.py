...
class BaseChannel(ABC):
    ...
    to integrate with the guide_cortex message bus.
    """
    ...
    async def transcribe_audio(self, file_path: str | Path) -> str:
        ...
        try:
            if self.transcription_provider == "openai":
                from guide_cortex.providers.transcription import OpenAITranscriptionProvider
                ...
                from guide_cortex.providers.transcription import GroqTranscriptionProvider
