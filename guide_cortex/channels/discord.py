...
from guide_cortex.utils.helpers import safe_filename, split_message
...
if DISCORD_AVAILABLE:
    ...
    class DiscordBotClient(discord.Client):
        ...
        async def send_outbound(self, msg: OutboundMessage) -> None:
            """Send a guide_cortex outbound message using Discord transport rules."""
...
class DiscordChannel(BaseChannel):
    ...
    async def start(self) -> None:
        ...
        if not DISCORD_AVAILABLE:
            self.logger.error("discord.py not installed. Run: pip install guide_cortex-ai[discord]")
            return
