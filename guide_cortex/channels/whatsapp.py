...
def _bridge_token_path() -> Path:
    from guide_cortex.config.paths import get_runtime_subdir
...
def _ensure_bridge_setup() -> Path:
    ...
    """
    from guide_cortex.config.paths import get_bridge_install_dir

    user_bridge = get_bridge_install_dir()
    stamp_file = user_bridge / ".guide_cortex-bridge-source-hash"
    ...
    if not source:
        raise RuntimeError(
            ...
            "Try reinstalling: pip install --force-reinstall guide_cortex"
        )
