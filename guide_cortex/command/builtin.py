...
from guide_cortex import __version__
from guide_cortex.bus.events import OutboundMessage
from guide_cortex.command.router import CommandContext, CommandRouter
from guide_cortex.utils.helpers import build_status_content
from guide_cortex.utils.restart import set_restart_notice_to_env
...
async def cmd_restart(ctx: CommandContext) -> OutboundMessage:
    ...
    async def _do_restart():
        ...
        os.execv(sys.executable, [sys.executable, "-m", "guide_cortex"] + sys.argv[1:])
...
async def cmd_status(ctx: CommandContext) -> OutboundMessage:
    ...
    with suppress(Exception):
        from guide_cortex.utils.searchusage import fetch_search_usage
